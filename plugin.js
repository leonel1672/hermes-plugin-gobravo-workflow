...
function mdToHtml(text) {
  ...
  // 6.5 Auto-link URLs (clickeables, con saltos de línea para destacarlas)
  h = h.replace(/\b(https?:\/\/[^\s<>\[\]()]+)/g, '<br><a href="$1" target="_blank" rel="noopener noreferrer" style="color:#58a6ff">$1</a><br>')
